        ...
        cargarJSON('examenes.json')
            .then(data => {
                if (data && Array.isArray(data.examenes)) {
                    ...
                    crearBotonesProcedimientos(procedimientosData, 'contenedorExamenes', ejecutarExamen);
...
function ejecutarExamen(id) {
    // Implementa la lógica específica para ejecutar un Examen aquí
    console.log(`Ejecutando examen con ID: ${id}`);
    // Aquí puedes añadir el código necesario para los Examenes
}
